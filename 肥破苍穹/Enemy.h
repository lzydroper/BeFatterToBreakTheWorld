...
enum EnemyTypes { RAT = 0, BIRD1, SPIDER, SCORPOION, SLIME };
...
public:
	...
	//Accessors
	const EnemyTypes getEnemyType() const { return enemyType; }
	...
	virtual void render(sf::RenderTarget & target, sf::Shader* shader = NULL, const sf::Vector2f light_position = sf::Vector2f(), const bool show_hitbox = test) = 0;
};
